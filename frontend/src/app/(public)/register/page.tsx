...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-black">
      {/* 회원가입 제한 안내 */}
      <div className="bg-gradient-to-r from-amber-600 to-orange-600 text-white py-4 border-b border-white/10">
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white/5 backdrop-blur-xl py-8 px-4 border border-white/10 sm:rounded-2xl sm:px-10">
            ...
            <div className="text-center mb-8">
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 mb-6 backdrop-blur-sm">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  ...
                  <span className="text-violet-400 font-medium">입부 시 작성한 국민대학교 이메일</span>로 로그인해주세요.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link 
                  href="/login"
                  className="bg-primary-500 hover:bg-primary-400 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 text-center hover:shadow-glow-primary"
                >
                  로그인하기
                </Link>
                <Link 
                  href="/recruit"
                  className="bg-white/5 hover:bg-white/10 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 text-center border border-white/10 hover:border-white/20"
                >
                  모집 안내 보기
                </Link>
              </div>
                ...
                <div className="flex justify-center">
                  <a 
                    href="mailto:aim@kookmin.ac.kr"
                     className="bg-amber-500/20 hover:bg-amber-500/30 text-amber-400 border border-amber-500/30 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 text-center"
                  >
                    📧 운영진에게 문의하기
                  </a>
                </div>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-black bg-primary-500 hover:bg-primary-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50"
                  >
